...
assignments_example |> prepare_data() |> dplyr::pull(fully_contains) |> sum()
assignments |> prepare_data() |> dplyr::pull(fully_contains) |> sum()

assignments_example |> prepare_data() |> dplyr::pull(overlaps) |> sum()
assignments |> prepare_data() |> dplyr::pull(overlaps) |> sum()
